...
// terbaca lewat view-source dan datanya di /backend/smokewatch/data/output/ tetap bisa
...
async function renderSkewTCard() {
  // skewt.js dibuang di Smokewatch (profil termodinamika tak ada kaitannya dengan
...
// ================= POPUP TITIK =================
// Atmosight memakai sidebar kanan. Di sini diganti POPUP tepat di titik yang
...
async function shareCurrent() {
  ...
  /* Dulu tertulis nama app CUACA di sini, warisan salah salin waktu app ini
     diklon. Bukan akibat penggantian nama, cacatnya sudah ada sejak awal. */
  const data = { title: "Smokewatch", text: "Lihat kualitas udara di Smokewatch", url };
  try {
...
// Untuk parameter Smokewatch, kunci layer SAMA dengan kunci variabelnya.
...
// Smokewatch tak punya layer tekanan, jadi legendanya memang tak ada. Kode isobar
// warisan Atmosight tetap ada tapi TIDAK boleh mematikan seluruh aplikasi saat dimuat.
...
// ---- Init --------------------------------------------------------------
// MODE CANGKANG. Smokewatch belum tersambung data CAMS, tapi peta, basemap,
...
// Domainnya SAMA PERSIS dengan Atmosight supaya bingkainya identik.
...
async function init() {
  ...
  try {
    ...
    // Smokewatch tak punya layer angin sendiri. Velocity ditempelkan ke tiap frame
...
// Warisan Atmosight (siklon, ITCZ, monsun, kondisi kota) memang tak berlaku
// di Smokewatch dan sudah disembunyikan CSS, jadi tak diikutkan.
const KET_SUMBER = [];

/* ==================================================================
   TATA LETAK HP: bilah bawah, chip parameter, tumpukan keterangan.

   Versi UMUM, dipakai bersama Atmosight, Kertas Fenomena, dan Kertas
